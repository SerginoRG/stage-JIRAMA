    ...
    <div class="modal-container">
        ...
        <div class="modal">
            ...
            <div class="container">
                ...
                <form action="../Controller/TypeHosipalisationUpdate.php" method="post">
                    <div class="form first">
                        <div class="details personal">
                            ...
                            <div class="input-field">
                                <label>Id type Hospitalisation</label>
                                <input type="text" name="id_type_hospitalisation" placeholder="Entré l'id type Hospitalisation" required>
                            </div>
                         

                            <div class="input-field"> 
                                <label>Nom hospitalisation</label>
                                <input type="text" name="nom_hospitalisation" placeholder="Entré Nom Hospitalisation "  required>
                           
                            </div>

                            <div class="input-field"> 
                                <label>Plafond</label>
                                <input type="number" name="plafond" placeholder="Entré le Plafond 50000Ar "  required>
                            </div>
...
?>
    ...
    <h4><a href="Type_HospitalisationTable.php">Voir le tableau</a></h4>
        <div class="meta">
                    ...
                    foreach ($resultat as $r) {
                        ...
                        <tr data-id="<?= $r[0] ?>"
                            ...
                            <td>
                                ...
                                <form class="simple" action="../Controller/TypeHosptalisationDelete.php" method="post" onsubmit="return confirmDelete(event, this);">
...
function confirmDelete(event, form) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
         ...
         <div class="container">
            ...
            <form action="../Controller/TypeHospitalisationAdd.php" method="post">
                <div class="form first">
                    <div class="details personal">
                        <span class="title">Information Type de Hospitalisation</span>
    ...
    const idField = document.querySelector('input[name="id_type_hospitalisation"]');
    const nomField = document.querySelector('input[name="nom_hospitalisation"]');
    const plafondField = document.querySelector('input[name="plafond"]');
    ...
    updateButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const plafond = row.dataset.plafond;
            

            // Remplir les champs du modal avec les valeurs extraites
            idField.value = id;
            nomField.value = nom;
            plafondField.value = plafond;
