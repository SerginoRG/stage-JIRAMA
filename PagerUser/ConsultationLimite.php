    ...
    <div class="modal-container">
        ...
        <div class="modal">
            ...
            <div class="container">
                ...
                <form action="../Controller/LimiteConsultationUpdate.php" method="post">
                    <div class="form first">
                        <div class="details personal">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" hidden name="id_type_consultation" placeholder="Entré l'id type consultation" required>
                            </div>
                         

                            <div class="input-field"> 
                                <label>Nom consultation</label>
                                <input type="text" name="nom_consultation" placeholder="Entré Nom consultation "  required>
                           
                            </div>

                            <div class="input-field"> 
                                <label>Plafond</label>
                                <input type="number" name="plafond" placeholder="Entré le Plafond 20000Ar "  required>
                            </div>
...
?>
    ...
    <h4><a href="ConsultationLimTabl.php">Voir le tableau</a></h4>
        <div class="meta">
                    ...
                    foreach ($resultat as $r) {
                        ...
                        <tr data-id="<?= $r[0] ?>"
                            ...
                            <td>
                                ...
                                <form class="simple" action="../Controller/LimiteConsultationDelete.php" method="post" onsubmit="return confirmDelete(event, this);">
...
function confirmDelete(event, form) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
         ...
         <div class="container">
            ...
            <form action="../Controller/LimiteConsultAdd.php" method="post">
                <div class="form first">
                    <div class="details personal">
                        <span class="title">Information Type de consultation</span>
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>Id type consultation</label>
                                <input type="text" name="id_type_consultation" placeholder="Entré l'id type consultation" required>
                            </div>
    ...
    const idField = document.querySelector('input[name="id_type_consultation"]');
    const nomField = document.querySelector('input[name="nom_consultation"]');
