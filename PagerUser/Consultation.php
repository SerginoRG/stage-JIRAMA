    ...
    <div class="modal-container">
        ...
        <div class="modal">
            ...
            <div class="container">
                ...
                <form action="../Controller/ConsultationUpdate.php" method="post">
                <div class="form first">
                    <div class="details personal">
                        ...
                        <div class="input-field">
                                ...
                                <input type="number" hidden name="id_consultation" placeholder="Entré l'id de la Demande" required>
                         
                                </div>

                                <div class="input-field">
                                    
                                    <input type="text" hidden name="type_consultation" placeholder="Entré le Type Consultation" required>
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" hidden name="id_demande" placeholder="Entré l'id de la Demande" required>
                            ...
                            <div class="input-field">
                                <label>Motif</label>
                                <input type="text" name="motif" placeholder="Entré le motif" required>
                            </div>
                            ...
                            <div class="input-field">
                                <label>Frais</label>
                                <input type="number" name="frais_consultation" placeholder="Entré le frais de consultation"  required>
                            </div>

                            <div class="input-field">
                                <label>Lieu de la consultation</label>
                                <input type="text" name="lieu_consultation" placeholder="Entré le lieu de la consultation" required>
...
?>
    ...
    <h4><a href="ConsultationTableau.php">Voir le tableau</a></h4>
        <div class="meta">
                    ...
                    foreach ($resultat as $r) {
                        ...
                        <tr data-id="<?= $r[0] ?>"
                            ...
                            <td>
                                ...
                                <form class="simple" action="../Controller/ConsultationDelete.php" method="post" onsubmit="return confirmDelete(event, this);">
                                    <input type="hidden" name="id_consultation" value="<?= $r[0] ?>">
                                    <input type="hidden" name="type_consultation" value="<?= $r[1] ?>">
                                    <input type="hidden" name="id_demande" value="<?= $r[2] ?>">
...
.error-box {
     ...
     select {
        ...
        padding-right: 30px;
         ...
         <div class="container">
            ...
            <form action="../Controller/ConsultationAdd.php" method="post">
                <div class="form first">
                    <div class="details personal">
                        <span class="title">Information de la consultation</span>
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <div class="input-field">
                                    ...
                                    <select name="type_consultation" id="select">
                                <?php
    ...
    const idField = document.querySelector('input[name="id_consultation"]');
    const consultationField = document.querySelector('input[name="type_consultation"]');
    ...
    const dateField = document.querySelector('input[name="date_consultation"]');
    const motifField = document.querySelector('input[name="motif"]');
    const fraisField = document.querySelector('input[name="frais_consultation"]');
    
    const lieuField = document.querySelector('input[name="lieu_consultation"]');
    ...
    updateButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const consultation = row.dataset.consultation;
            ...
            idField.value = id;
            consultationField.value = consultation;
            demandeField.value = demande;
            pieceField.value = piece;
            
            dateField.value = date;
            
            motifField.value = motif;
