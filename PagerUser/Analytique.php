    ...
    <div class="modal-container">
        ...
        <div class="modal">
            ...
            <div class="container">
                ...
                <form action="../Controller/AnalytiqueUpdate.php" method="post">
                    <div class="form first">
                        <div class="details personal">
                            <span class="title">Information de l'analytique</span>
                            ...
                            <div class="fields">
                                ...
                                <div class="input-field">
                                    <label>Nom de l'analytique</label>
                                    <input type="text" name="nom_analytique" placeholder="Entré le nom de l'analytique" required>
                                </div>
...
?>
    ...
    <h4><a href="AnalytiqueTableau.php">Voir le tableau</a></h4>
        <div class="meta">
            <form action="Analytique.php" method="post"> 
    ...
    if (isset($_POST['recherche']) && !empty($_POST['rech'])) {
        $s = new Analytique();
        $s->setId_analytique($_POST['rech']);
        
        // Rechercher par matricule
        $resultat = $tab->search_Analytique($s);
                    ...
                    foreach ($resultat as $r) {
                        ...
                        <tr data-id="<?= $r[0] ?>"
                            ...
                            <td>
                                ...
                                <form class="simple" action="../Controller/AnalytiqueDelete.php" method="post" onsubmit="return confirmDelete(event, this);">
                                    <input type="hidden" name="id_analytique" value="<?= $r[0] ?>">
...
.error-box {
 ...
 -->
         ...
         <div class="container">
            ...
            <form action="../Controller/AnalytiqueController.php" method="post">
                <div class="form first">
                    <div class="details personal">
                        <span class="title">Information de l'analytique</span>
                        ...
                        <div class="fields">
                            <div class="input-field">
                                <label>Id  </label>
                                <input type="text" name="id_analytique" placeholder="Entré l'id" required>
                            </div>
    ...
    const idField = document.querySelector('input[name="id_analytique"]');
    const analytiqueField = document.querySelector('input[name="nom_analytique"]');
